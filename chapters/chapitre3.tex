...
\begin{minipage}[t]{0.46\textwidth}
	...
	% VSCode offre des fonctionnalités avancées telles que le débogage intégré, la gestion des versions avec Git, et un large éventail d'extensions pour divers langages de programmation.
\end{minipage}
\hfill
\begin{minipage}[t]{0.46\textwidth}
...
\begin{minipage}[t]{0.46\textwidth}
	\begin{center}
		\textbf{Google Colab} \\
		\includegraphics[width=0.5\textwidth]{images/logoColabs}\\ % Remplacez par le chemin de votre logo
	\end{center}
...
\begin{minipage}[t]{0.46\textwidth}
	\begin{center}
		\textbf{Pandas} \\
		\includegraphics[width=0.6\textwidth]{images/logoPandas} % Remplacez par le chemin de votre logo
	\end{center}
...
\begin{minipage}[t]{0.46\textwidth}
	\begin{center}
		\textbf{BeautifulSoup} \\
		\includegraphics[width=0.6\textwidth]{images/logobeautifulsoup} % Remplacez par le chemin de votre logo
	\end{center}
...
\begin{minipage}[t]{0.46\textwidth}
	...
	\end{center}
	%\includegraphics[width=0.6\textwidth]{logo_matplotlib.png} % Remplacez par le chemin de votre logo
...
\begin{minipage}[t]{1\textwidth}
	...
	\end{center}
	%\includegraphics[width=0.6\textwidth]{logo_git.png} % Remplacez par le chemin de votre logo
